...
namespace Calculator
{
    public partial class Form1 : Form
    {
        ...
        private Button[] buttonOperator = new Button[5];
        private Button[] buttonOperator2 = new Button[4];
        ...
        private void InitializeNumericButtons()
        {
            ...
            for (int i = 1; i < buttonNumeric.Length; i++)
            {
                ...
                this.buttonNumeric[i].Location = new Point(40 + ((i - 1) % 3) * 50, 288 - ((i - 1) / 3) * 50);
                if (index == 0)
                {
                    index += 2;
                }
        ...
        private void InitializeOperatorButtons()
        {
            ...
            for (int i = 0; i < buttonOperator.Length; i++)
            {
                ...
                this.buttonOperator[i].Location = new Point(285, 216 + i * 76);
                this.buttonOperator[i].Name = "button" + (i + 11);
                this.buttonOperator[i].Size = new Size(53, 53);
            ...
            string[] operatorSymbols2 = { "%", "1/x", "x^2", "sqrt" };
            for (int i = 0; i < operatorSymbols2.Length; i++)
            {
                this.buttonOperator2[i] = new Button();
                if (i > 0)
                {
                    this.buttonOperator2[i].Location = new Point(-15 + (i * 75), 215); //2
                }
                else
                {
                    this.buttonOperator2[i].Location = new Point(60, 145); //1
                }
        ...
        private void InitializeBackspaceButton()
        {
            ...
            buttonBackspace.Location = new Point(190, 94);
        ...
        {
            ButtonC = new Button();
            ButtonC.Location = new Point(90, 94);
        ...
        private void InitializeButtonCE()
        {
            ButtonCE = new Button();
            ButtonCE.Location = new Point(140, 94);
            ButtonCE.Name = "ButtonCE";
            ButtonCE.Size = new Size(35, 35);
            ButtonCE.Text = "CE";
            ButtonCE.UseVisualStyleBackColor = true;
            ButtonCE.Click += new EventHandler(this.button16_Click);
        ...
        private void InitializeButtonSign()
        {
            ...
            ButtonSign.Location = new Point(40, 338);
        ...
        private void InitializeButtonDecimal()
        {
            ...
            ButtonDecimal.Location = new Point(140, 338);
        ...
        private void InitializeButtonZero()
        {
            ...
            ButtonZero.Location = new Point(90, 338);
